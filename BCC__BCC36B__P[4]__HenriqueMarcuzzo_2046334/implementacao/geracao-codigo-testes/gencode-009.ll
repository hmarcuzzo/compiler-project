...
@"C" = common global [1024 x i32] zeroinitializer, align 4
...
loop:
  %".5" = load i32, i32* %"i"
  %"C_i" = getelementptr [1024 x i32], [1024 x i32]* @"C", i32 0, i32 %".5"
  %".6" = load i32, i32* %"i"
  %"A[i]" = getelementptr [1024 x i32], [1024 x i32]* @"A", i32 0, i32 %".6"
  %".7" = load i32, i32* %"A[i]", align 4
  %"expression.1" = add i32 0, %".7"
  %".8" = load i32, i32* %"i"
  %"B[i]" = getelementptr [1024 x i32], [1024 x i32]* @"B", i32 0, i32 %".8"
...
loop:
  %".5" = load i32, i32* %"i"
  %"A_i" = getelementptr [1024 x i32], [1024 x i32]* @"A", i32 0, i32 %".5"
  %"expression.1" = add i32 0, 1
  store i32 %"expression.1", i32* %"A_i"
  %".7" = load i32, i32* %"i"
  %"B_i" = getelementptr [1024 x i32], [1024 x i32]* @"B", i32 0, i32 %".7"
...
loop.1:
  %".19" = load i32, i32* %"i"
  %"C[i]" = getelementptr [1024 x i32], [1024 x i32]* @"C", i32 0, i32 %".19"
